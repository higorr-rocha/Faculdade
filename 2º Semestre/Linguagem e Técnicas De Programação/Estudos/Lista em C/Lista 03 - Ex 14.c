/*
    ...
    Nome        : Lista - Ex 11
    Descrição   : Solicita os dados de 12 pessoas (nome, idade, sexo, quantidade de filhos) e apresenta:
                  ...
                  Todos os dados deverão ser validados na entrada.
    Autor       : Higor Rocha
...
int main(){
    int idade, idade_n=200, filhos, mulheres=0, mulheres_f, i, cont, cont2;
